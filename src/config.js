...
export const BUILDINGS = [
  {
    ...
    baseCost: { ore: 200, oil: 80, metal: 120, power: 120, research: 30 }, costGrowth: 1.18,
  ...
  },
  {
    ...
    isWarehouse: true,
    baseCost: { ore: 180, oil: 70, metal: 100, power: 25, research: 20 }, costGrowth: 1.18,
  ...
  },
  {
    ...
    produces: { ore: 1.0 },
    baseCost: { ore: 160, oil: 50, metal: 60, power: 15, research: 10 }, costGrowth: 1.18,
  ...
  },
  {
    ...
    produces: { oil: 0.6 },
    baseCost: { ore: 170, oil: 40, metal: 70, power: 18, research: 12 }, costGrowth: 1.18,
  ...
  },
  {
    ...
    produces: { metal: 0.45 },
    baseCost: { ore: 175, oil: 60, metal: 40, power: 20, research: 15 }, costGrowth: 1.18,
    buildTime: 14, timeGrowth: 2.5,
  },
  {
    id: 'lab', name: '科研实验室',
    desc: '产出科研点（用于兵种进阶），每级再为全军提供 +5% 攻击。',
    produces: { research: 0.32 },
    armyAtkPerLevel: 0.05,
    baseCost: { ore: 180, oil: 80, metal: 90, power: 28, research: 12 }, costGrowth: 1.18,
  ...
  },
  {
    ...
    baseCost: { ore: 185, oil: 60, metal: 100, power: 25, research: 18 }, costGrowth: 1.18,
  ...
  },
  {
    ...
    trainsFamily: 'tank',
    baseCost: { ore: 190, oil: 110, metal: 150, power: 45, research: 28 }, costGrowth: 1.18,
  ...
  },
  {
    ...
    baseCost: { ore: 195, oil: 140, metal: 160, power: 55, research: 38 }, costGrowth: 1.18,
...
const UNIT_FAMILIES = {
  barracks: {
    ...
    hp: 50, atk: 12, statGrowth: 1.62, cost: { ore: 20, oil: 5 }, costGrowth: 1.5,
    trainTime: 4, timeGrowth: 1.42,
  },
  vehicleFactory: {
    family: 'tank', art: 'tank',
    names: ['轻型战车', '装甲车', '反坦克车', '主战坦克', '火箭车', '防空车', '重型坦克', '导弹车', '巨炮战车', '末日战车'],
    hp: 200, atk: 38, statGrowth: 1.6, cost: { ore: 60, oil: 25, metal: 40, power: 5 }, costGrowth: 1.5,
    trainTime: 10, timeGrowth: 1.4,
  },
  airfield: {
    family: 'aircraft', art: 'aircraft',
    names: ['侦察机', '战斗机', '攻击机', '轰炸机', '武装直升机', '隐形战机', '电子战机', '空中炮艇', '战略轰炸机', '末日空母'],
    hp: 110, atk: 75, statGrowth: 1.6, cost: { ore: 50, oil: 55, metal: 30, power: 10 }, costGrowth: 1.5,
